...
import com.hhtuann.backend.realtime.support.BrokerSubscribeHoldProbe;
...
class BrokerSubscriptionHandledProbeTest extends RealtimeStompTestBase {
    ...
    @Autowired com.hhtuann.backend.realtime.support.ChannelFlowProbeRegistrar flowProbeRegistrar;
