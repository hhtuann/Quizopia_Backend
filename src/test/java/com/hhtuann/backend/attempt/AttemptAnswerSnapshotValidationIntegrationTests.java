...
import com.hhtuann.backend.attempt.application.AnswerPayloadValidator;
...
class AttemptAnswerSnapshotValidationIntegrationTests {
    ...
    private static String code(Throwable e) {
        return ((com.hhtuann.backend.attempt.exception.AttemptException) e).getErrorCode().code();
    }
