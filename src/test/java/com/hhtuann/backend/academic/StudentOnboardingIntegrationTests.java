...
/**
 * Integration tests for the Student Onboarding API (V11): pending-students
 * list,
...
class StudentOnboardingIntegrationTests {
        ...
        void listPendingSearchByUsername() {
                PageResponse<PendingStudentItem> page = onboardingService.listPendingStudents(adminUserId, "pend", 0,
                                20);
        ...
        void assignStudentCreatesProfileWithAutoCode() {
                StudentProfileResponse resp = onboardingService.assignStudentToSchool(adminUserId, pendingStudentUserId,
                                schoolId);
        ...
        void assignStudentTwiceReturns409() {
                ...
                assertThatThrownBy(() -> onboardingService.assignStudentToSchool(adminUserId, pendingStudentUserId,
                                schoolId))
        ...
        void teacherCannotAssignStudent() {
                assertThatThrownBy(() -> onboardingService.assignStudentToSchool(teacherUserId, pendingStudentUserId,
                                schoolId))
                                .isInstanceOf(AcademicException.class)
                                .satisfies(e -> assertThat(((AcademicException) e).getErrorCode().name())
