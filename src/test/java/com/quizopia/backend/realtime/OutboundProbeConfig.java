...
public class OutboundProbeConfig implements WebSocketMessageBrokerConfigurer {
    ...
    @Bean
    com.quizopia.backend.realtime.support.RepositoryLockEntryProbe repositoryLockEntryProbe() {
        return new com.quizopia.backend.realtime.support.RepositoryLockEntryProbe();
    }

    @Bean
    com.quizopia.backend.realtime.support.ChannelFlowProbeRegistrar channelFlowProbeRegistrar() {
        return new com.quizopia.backend.realtime.support.ChannelFlowProbeRegistrar();
    }
