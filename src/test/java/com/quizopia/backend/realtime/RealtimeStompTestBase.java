...
import com.quizopia.backend.security.token.JwtAccessTokenService;
...
public abstract class RealtimeStompTestBase {
    ...
    @Autowired protected com.quizopia.backend.realtime.support.RepositoryLockEntryProbe lockProbe;
