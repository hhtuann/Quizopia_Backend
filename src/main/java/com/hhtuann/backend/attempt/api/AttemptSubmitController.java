 ...
 * com.hhtuann.backend.grading.AttemptGradingService}) within the same transaction — one immutable
 * {@link com.hhtuann.backend.attempt.domain.model.Grade} + {@link com.hhtuann.backend.attempt.domain.model.GradeItem}s
