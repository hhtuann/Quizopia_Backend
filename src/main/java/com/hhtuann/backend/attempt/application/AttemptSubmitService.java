...
import com.hhtuann.backend.attempt.domain.model.IdempotencyOperation;
import com.hhtuann.backend.attempt.domain.model.IdempotencyRecord;
...
import com.hhtuann.backend.attempt.repository.IdempotencyRecordRepository;
...
public class AttemptSubmitService {
    ...
    public SubmitResponse submitAttempt(Long userId, Long attemptId, SubmitRequest request) {
        ...
        // 4. Capture `now` ONCE, AFTER the lock. Deadline is checked at acquire time.
