package com.quizopia.backend.user.application;
...
import com.quizopia.backend.identity.domain.model.UserRoleId;
import com.quizopia.backend.identity.domain.model.UserStatus;
import com.quizopia.backend.identity.repository.RoleRepository;
...
import com.quizopia.backend.security.encryption.SensitiveDataEncryptor;
import com.quizopia.backend.security.password.PasswordHasher;
import com.quizopia.backend.user.dto.AssignRoleRequest;
import com.quizopia.backend.user.dto.CreateUserRequest;
import com.quizopia.backend.user.dto.RoleListResponse;
import com.quizopia.backend.user.dto.RoleResponse;
import com.quizopia.backend.user.dto.UpdateUserRequest;
import com.quizopia.backend.user.dto.UserListItem;
import com.quizopia.backend.user.dto.UserResponse;
